<template>
  <div class="orderSum">
    <div class="orderSum-top">
      <div class="orderSum-top-item" style="margin-right: 79px;">
        <div class="orderSum-top-item-left">
          <img src="../../assets/pensionServices/icon_amount@2x.png" alt="" />
        </div>
        <div class="orderSum-top-item-right">
          <div>总金额(万元)</div>
          <div>
            <ICountUp
              :start="0"
      ...
      <div class="orderSum-top-item">
        <div class="orderSum-top-item-left">
          <img src="../../assets/pensionServices/icon_subsidy@2x.png" alt="" />
        </div>
        <div class="orderSum-top-item-right">
          <div>补贴金额(万元)</div>
          <div>
      ...
      this.$axios({
        ...
        if (data) {
          function init() {
            ...
            this.$refs.value2 && this.$refs.value2.update(
      ...
      this.$axios({
        ...
        if (data) {
          function init() {
            ...
            this.$refs.value8 && this.$refs.value8.update(parseFloat(data.vediocount).toFixed(1));
          }
          init.call(this);
          clearInterval(this.innertimer);
          this.innertimer= setInterval(() => {
