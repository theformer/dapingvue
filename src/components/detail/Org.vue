  ...
  <Common title="活动组织">
    <div class="total">
      <div class="flex align-center flex-center" style="padding: 36px 0">
        <img src="@/assets/lc/activity.png" class="icon" />
        <div class="value">
          <ICountUp
            :start="0"
            :endVal="0"
      ...
      // vediohealthrate	string	视频问诊健康率
        if (data) {
          function init() {
            ...
            this.$refs.value && this.$refs.value.update(parseInt(data.activitycount));
            this.$refs.value1 && this.$refs.value1.reset();
            this.$refs.value1 && this.$refs.value1.update(data.activityoldercount);
            this.$refs.value2 && this.$refs.value2.reset();
            this.$refs.value2 && this.$refs.value2.update(parseFloat(data.activityrate ).toFixed(1));
          }
          init.call(this);
