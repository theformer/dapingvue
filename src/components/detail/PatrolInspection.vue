    ...
    getData() {
      this.$axios({
        ...
        if (data) {
          ...
          this.qualified = parseFloat(data.checkHgRate) + "%";
          this.noqualified = parseFloat(data.checkBdbRate) + "%";
...
.patrolInspection {
  ...
  .circle-top-left {
    ...
    top: -5px;
    left: -5px;
    box-shadow: 0 0 8px 2px rgba(79, 220, 255, 0.4);
  }
  .circle-top-right {
    width: 2px;
    height: 2px;
