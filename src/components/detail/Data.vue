  ...
  <Common title="服务订单">
    <div class="data">
      <div class="flex align-center flex-center">
        <div class="data-title">总金额（万元）</div>
      ...
      <div class="data-item">
        ...
        >
          <div>
            ...
            <div class="data-content-dec">服务订单数</div>
          </div>
          <div class="chart-box">
          ...
          <div class="flex flex-column align-end">
            ...
            <div class="data-content-dec">服务订单完成数</div>
          </div>
        </div>
      </div>
      <div class="data-item">
        ...
        >
          <div>
            ...
            <div class="data-content-dec">订单评价数</div>
          </div>
          <div class="chart-box">
            <div class="position-relative">
          ...
          <div class="flex flex-column align-end">
            ...
            <div class="data-content-dec">人均服务订单</div>
          </div>
        </div>
      </div>
    </div>
      ...
      this.$axios({
        ...
        if (data) {
          function init() {
            ...
            this.$refs.value1 && this.$refs.value1.update(parseInt(data.ordercount));
            this.$refs.value2 && this.$refs.value2.reset();
            this.$refs.value2 && this.$refs.value2.update(parseFloat(data.ordercompleterate).toFixed(1));
            this.$refs.value3 && this.$refs.value3.reset();
            this.$refs.value3 && this.$refs.value3.update(parseInt(data.ordercompletecount));

            this.$refs.value4 && this.$refs.value4.reset();
            this.$refs.value4 && this.$refs.value4.update(parseInt(data.pjcount));
            this.$refs.value5 && this.$refs.value5.reset();
            this.$refs.value5 && this.$refs.value5.update(parseFloat(data.pjgoodrate).toFixed(1));
            this.$refs.value6 && this.$refs.value6.reset();
            this.$refs.value6 && this.$refs.value6.update(parseInt(data.pjgoodcount));

            this.$refs.value7 && this.$refs.value7.reset();
            this.$refs.value7 && this.$refs.value7.update(parseInt(data.ordertotalamount));
